...
vector<double> metropolis(vector<double>, int, double (*p)(vector<double>), vector<double> (*T)(vector<double>, double), double, bool (*A)(vector<double>, vector<double>, double (*parg)(vector<double>)) );
